...
<head>
    ...
    <title>ParaSante | Confirmer le mot de passe</title>
    ...
    <style>
        ...
        /* الكانفاس التفاعلي للـ Particles */
        #particle-canvas {
            position: absolute;
            top: 0;
            left: 0;
    ...
    <div class="w-full max-w-md relative z-10 floating-card">
        ...
        <div class="glass-panel rounded-3xl border border-white/40 shadow-[0_0_50px_rgba(16,185,129,0.15)] p-8 sm:p-10 transition-all duration-500 hover:shadow-[0_0_60px_rgba(16,185,129,0.25)] hover:border-emerald-200/50">
            ...
            <div class="text-center mb-6">
                ...
                <h2 class="text-lg font-bold text-slate-800 tracking-tight">Zone Sécurisée</h2>
                <p class="text-xs text-slate-500 mt-1">Veuillez confirmer votre mot de passe avant de continuer.</p>
            </div>

            <div class="mb-5 p-4 bg-amber-50/80 backdrop-blur-sm border border-amber-100 rounded-2xl text-xs text-amber-700 font-semibold shadow-sm flex items-start gap-2.5">
                ...
                <span>Il s'agit d'une zone hautement sécurisée. Saisissez votre mot de passe actuel.</span>
            </div>
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" name="password" required autofocus autocomplete="off" placeholder="••••••••"
